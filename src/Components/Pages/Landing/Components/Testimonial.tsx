const Testimonial = ({ image }: { image: any }) => {
  return (
    <>
      <div className="relative flex justify-end bg-gray-100 border shadow-lg shadow-white rounded-xl items-end flex-col h-96 w-full">
        ...
        <div className="relative w-full mt-5 px-5 py-5 flex justify-end items-center">
