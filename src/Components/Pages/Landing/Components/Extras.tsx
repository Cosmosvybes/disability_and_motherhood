  ...
  return (
    <>
      <div className="relative flex justify-between max-sm:gap-2 items-center max-sm:flex-col shadow shadow-white  py-5  h-auto px-20 max-sm:px-2 ">
        <div className="relative px-5 max-sm:px-2  h-96 max-sm:h-auto w-full justify-between items-center  flex bg-black rounded-none max-sm:rounded-br-xl max-sm:rounded-bl-xl  ">
          <h1 className="text-center text-gray-300 inline  max-sm:text-4xl max-sm:py-2 text-8xl font-extrabold">
