...
const WelcomeSection = () => {
  const [indicatorMenu] = useState([
    {
      id: 1,
      icon: <SpringNotes className="text-4xl max-sm:text-2xl text-white animate-pulse" />,
      title: "Education",
      description:
    ...
    {
      id: 2,
      icon: <BookInfo className="text-4xl max-sm:text-2xl text-white animate-pulse" />,
    ...
    {
      id: 3,
      icon: <UsersTriple className="text-4xl max-sm:text-2xl text-white animate-pulse" />,
      title: "Community",
      description:
        "Learn about the eductaion for the disabilities and every other information needed.",
    },
    {
      id: 4,
      icon: <HealthCare className="text-4xl max-sm:text-2xl text-white animate-pulse" />,
      title: "Support",
      description:
        "Learn about the eductaion for the disabilities and every other information needed.",
    },
