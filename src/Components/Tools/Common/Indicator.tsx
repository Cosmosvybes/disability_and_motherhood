  ...
  return (
    <>
      <Link to={title} smooth duration={600} className="cursor-pointer">
        <div className="relative w-full h-44 flex px-2 justify-start max-sm:justify-start  gap-5 max-sm:gap-3 items-center  bg-white  rounded-bl-3xl rounded-tr-3xl py-5">
