const Indicator = ({
  ...
  return (
    <>
      <div className="relative w-full h-44 flex px-2 justify-start max-sm:justify-start  gap-5 max-sm:gap-3 items-center border bg-gray-50  rounded-bl-3xl rounded-tr-3xl py-5">
